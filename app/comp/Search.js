...
function Search() {
  ...
  //close search window when user click esc
  useEffect(() => {
    document.addEventListener("keyup", handlesearchKeyPress)
    return () => document.removeEventListener("keyup", handlesearchKeyPress)
  }, [])
  ...
  //  if user search, add to requestCount after delay
  useEffect(() => {
  ...
  // if requestCount is changed, fetch data for search term
  useEffect(() => {
  ...
  // save search query input to state
    ...
    <div className="search-overlay">
      <div className="search-overlay-top shadow-sm">
        <div className="container container--narrow">
          ...
          <input onChange={handleSearchQuery} autoFocus type="text" autoComplete="off" id="live-search-field" className="live-search-field" placeholder="What are you interested in?" />
